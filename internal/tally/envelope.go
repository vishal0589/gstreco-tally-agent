      ...
      <TDL>
        <TDLMESSAGE>
          <COLLECTION NAME="GstrecoVoucherCollection" ISINITIALIZE="Yes">
            ...
            <FETCH>ALLLEDGERENTRIES.LEDGERNAME, ALLLEDGERENTRIES.AMOUNT, ALLLEDGERENTRIES.GSTCLASS, ALLLEDGERENTRIES.ISDEEMEDPOSITIVE, ALLLEDGERENTRIES.ISPARTYLEDGER, ALLLEDGERENTRIES.BILLALLOCATIONS, ALLLEDGERENTRIES.BANKALLOCATIONS, ALLLEDGERENTRIES.RATEDETAILS</FETCH>
            <FETCH>LEDGERENTRIES.LEDGERNAME, LEDGERENTRIES.AMOUNT, LEDGERENTRIES.GSTCLASS, LEDGERENTRIES.ISDEEMEDPOSITIVE, LEDGERENTRIES.ISPARTYLEDGER, LEDGERENTRIES.BILLALLOCATIONS, LEDGERENTRIES.BANKALLOCATIONS, LEDGERENTRIES.RATEDETAILS</FETCH>
            <FETCH>ALLINVENTORYENTRIES.STOCKITEMNAME, ALLINVENTORYENTRIES.ACTUALQTY, ALLINVENTORYENTRIES.BILLEDQTY, ALLINVENTORYENTRIES.RATE, ALLINVENTORYENTRIES.AMOUNT, ALLINVENTORYENTRIES.GSTHSNNAME, ALLINVENTORYENTRIES.ISDEEMEDPOSITIVE, ALLINVENTORYENTRIES.BATCHALLOCATIONS, ALLINVENTORYENTRIES.ACCOUNTINGALLOCATIONS, ALLINVENTORYENTRIES.RATEDETAILS</FETCH>
            <FETCH>INVENTORYENTRIES.STOCKITEMNAME, INVENTORYENTRIES.ACTUALQTY, INVENTORYENTRIES.BILLEDQTY, INVENTORYENTRIES.RATE, INVENTORYENTRIES.AMOUNT, INVENTORYENTRIES.GSTHSNNAME, INVENTORYENTRIES.ISDEEMEDPOSITIVE, INVENTORYENTRIES.BATCHALLOCATIONS, INVENTORYENTRIES.ACCOUNTINGALLOCATIONS, INVENTORYENTRIES.RATEDETAILS</FETCH>
            <FETCH>INVENTORYENTRIESIN.STOCKITEMNAME, INVENTORYENTRIESIN.ACTUALQTY, INVENTORYENTRIESIN.BILLEDQTY, INVENTORYENTRIESIN.RATE, INVENTORYENTRIESIN.AMOUNT, INVENTORYENTRIESIN.GSTHSNNAME, INVENTORYENTRIESIN.ISDEEMEDPOSITIVE, INVENTORYENTRIESIN.BATCHALLOCATIONS, INVENTORYENTRIESIN.ACCOUNTINGALLOCATIONS, INVENTORYENTRIESIN.RATEDETAILS</FETCH>
            <FETCH>INVENTORYENTRIESOUT.STOCKITEMNAME, INVENTORYENTRIESOUT.ACTUALQTY, INVENTORYENTRIESOUT.BILLEDQTY, INVENTORYENTRIESOUT.RATE, INVENTORYENTRIESOUT.AMOUNT, INVENTORYENTRIESOUT.GSTHSNNAME, INVENTORYENTRIESOUT.ISDEEMEDPOSITIVE, INVENTORYENTRIESOUT.BATCHALLOCATIONS, INVENTORYENTRIESOUT.ACCOUNTINGALLOCATIONS, INVENTORYENTRIESOUT.RATEDETAILS</FETCH>
